...
- **Детекторы** разделены по зонам ответственности: `anpr/detection/motion_detector.py` отвечает за фильтрацию движения и подключается по слабой зависимости, `anpr/pipeline/factory.py` собирает YOLO/CRNN/пайплайн распознавания без привязки к UI.
